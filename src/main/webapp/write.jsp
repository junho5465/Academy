...
<script type="text/javascript">
        ...
        location.href='<%=request.getContextPath()%>/viewProc.do?userId=<%=session.getAttribute("userId")%>&subjectName=${user.subjectName}';
    </script>
<%} %>
<body>
		...
		<div class="col-lg-8 bg-box3">
			...
			<div class="col-lg-7">
				...
				<div class="write-box">
					...
					<form method="post"
						action="<%=request.getContextPath()%>/writeProc.do">
						<input type="hidden" value="<%=session.getAttribute("userId")%>"
							name="userId"> <input type="hidden"
							value="${user.subjectName }" name="subjectName"> <input
